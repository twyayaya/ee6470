...
module SobelFilter(i_clk, i_rst, i_r_busy, i_r_vld, i_r_data, i_g_busy, i_g_vld, i_g_data, i_b_busy, i_b_vld, i_b_data, o_result_r_busy, o_result_r_vld, o_result_r_data, o_result_g_busy, o_result_g_vld, o_result_g_data, o_result_b_busy, o_result_b_vld, o_result_b_data);
      ...
      reg SobelFilter_N_Muxb_1_2_0_4_16_out1;
      ...
      reg SobelFilter_N_Muxb_1_2_0_4_13_out1;
      ...
      reg SobelFilter_N_Muxb_1_2_0_4_10_out1;
      reg i_r_m_unvalidated_req;
      wire SobelFilter_gen_busy_r_4_34_gnew_req_i1;
      wire SobelFilter_gen_busy_r_4_34_gdiv_i3;
      wire SobelFilter_gen_busy_r_4_34_gen_busy_0_i_r_m_data_is_invalid_next;
      reg[3:0] global_state_next;
      reg[11:0] SobelFilter_Add_12Ux12U_12U_4_24_in1;
      /*signed*/wire[11:0] SobelFilter_Mul_12Sx8U_12S_4_23_out1;
      reg[7:0] SobelFilter_Mul_12Sx8U_12S_4_23_in1;
      /*signed*/reg[11:0] SobelFilter_Mul_12Sx8U_12S_4_23_in2;
      reg gs_ctrl0;
      wire[3:0] SobelFilter_Add_4Ux2U_4U_4_20_out1;
      /*signed*/wire[11:0] SobelFilter_Mul_12Sx8U_12S_4_22_out1;
      reg[11:0] s_reg_26;
      reg[11:0] s_reg_25;
      wire[1:0] SobelFilter_Add_2Ux1U_2U_4_18_out1;
      wire[1:0] SobelFilter_Add_2Ux1U_2U_4_21_out1;
      reg[1:0] s_reg_23;
      reg[11:0] s_reg_22;
      wire[11:0] SobelFilter_Add_12Ux12U_12U_4_24_out1;
      reg[1:0] s_reg_24;
      reg[1:0] s_reg_19;
      wire SobelFilter_And_1Ux1U_1U_4_30_out1;
      wire SobelFilter_And_1Ux1U_1U_4_31_out1;
      wire SobelFilter_And_1Ux1U_1U_4_32_out1;
      wire[2:0] SobelFilter_gen_busy_r_4_34_out1;
      ...
      wire[11:0] SobelFilter_Add_12Ux12U_12U_4_28_out1;
      wire SobelFilter_LessThan_2Ux2U_1U_4_29_out1;
      wire SobelFilter_LessThan_2Ux2U_1U_4_27_out1;
      reg[11:0] s_reg_21;
      reg[11:0] s_reg_20;
      wire[3:0] SobelFilter_Mul_2Ux2U_4U_4_19_out1;
      ...
      wire[31:0] filter_out1;
            ...
            case (stall0) 
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     4'd02:                      begin
                        o_result_b_data <= {4'b0000, SobelFilter_Mul_2Ux2U_4U_4_19_out1};
                     end
            ...
            case (stall0) 
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     4'd05:                      begin
                        if (!SobelFilter_LessThan_2Ux2U_1U_4_29_out1 && !SobelFilter_LessThan_2Ux2U_1U_4_27_out1) begin
                           o_result_r_data <= SobelFilter_Add_12Ux12U_12U_4_28_out1[11:4];
                        end
                     end
               ...
               case (stall0) 
                  ...
                  1'b0:                   begin
                     case (global_state) 
                        ...
                        4'd05:                         begin
                           if (SobelFilter_LessThan_2Ux2U_1U_4_29_out1) begin
                              i_r_m_busy_req_0 <= 1'd0;
                           end
                           else begin
         ...
         always @(SobelFilter_And_1Ux1U_1U_4_30_out1 or SobelFilter_And_1Ux1U_1U_4_31_out1 or SobelFilter_And_1Ux1U_1U_4_32_out1 or SobelFilter_gen_busy_r_4_34_out1[0] or SobelFilter_gen_busy_r_4_35_out1[0] or SobelFilter_gen_busy_r_4_36_out1[0] or global_state)
          begin :drive_stall0
            case (global_state) 

               4'd01:                begin
                  stall0 = SobelFilter_gen_busy_r_4_34_out1[0];
               end
               ...
               4'd06:                begin
                  stall0 = SobelFilter_And_1Ux1U_1U_4_30_out1;
               end
            ...
            case (stall0) 
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     4'd05:                      begin
                        s_reg_20 <= SobelFilter_Add_12Ux12U_12U_4_24_out1;
                     end
            ...
            case (stall0) 
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     4'd04:                      begin
                        s_reg_21 <= SobelFilter_Add_12Ux12U_12U_4_24_out1;
                     end
            ...
            case (stall0) 
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     4'd05:                      begin
                        s_reg_22 <= SobelFilter_Add_12Ux12U_12U_4_28_out1;
                     end
            ...
            case (stall0) 
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     4'd03:                      begin
                        s_reg_23 <= SobelFilter_Add_2Ux1U_2U_4_21_out1;
                     end
            ...
            case (stall0) 
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     4'd02:                      begin
                        s_reg_24 <= SobelFilter_Add_2Ux1U_2U_4_18_out1;
                     end
         ...
         always @(posedge i_clk)
          begin :drive_s_reg_26
            case (stall0) 
               ...
               1'b0:                begin
                  s_reg_26 <= SobelFilter_Mul_12Sx8U_12S_4_22_out1;
               end
         ...
         assign SobelFilter_Add_2Ux1U_2U_4_18_out1 = s_reg_19 + 2'd1;

         // resource: SobelFilter_Mul_2Ux2U_4U_4  instance: SobelFilter_Mul_2Ux2U_4U_4_19
         assign SobelFilter_Mul_2Ux2U_4U_4_19_out1 = {2'b00, s_reg_19}*4'd03;

         // resource: SobelFilter_Add_4Ux2U_4U_4  instance: SobelFilter_Add_4Ux2U_4U_4_20
         assign SobelFilter_Add_4Ux2U_4U_4_20_out1 = o_result_b_data[3:0] + {2'b00, s_reg_23};

         // resource: SobelFilter_Add_2Ux1U_2U_4  instance: SobelFilter_Add_2Ux1U_2U_4_21
         assign SobelFilter_Add_2Ux1U_2U_4_21_out1 = s_reg_23 + 2'd1;

         // instance: drive_filter_in1
         assign filter_in1 = SobelFilter_Add_4Ux2U_4U_4_20_out1;

         // resource: SobelFilter_Mul_12Sx8U_12S_4  instance: SobelFilter_Mul_12Sx8U_12S_4_22
         assign SobelFilter_Mul_12Sx8U_12S_4_22_out1 = filter_out1[11:0]*{4'b0000, o_result_r_data};

         // resource: mux_12bx2i0c
         always @(s_reg_25 or filter_out1[11:0] or gs_ctrl0)
          begin :drive_SobelFilter_Mul_12Sx8U_12S_4_23_in2
            if (gs_ctrl0) begin
               SobelFilter_Mul_12Sx8U_12S_4_23_in2 = s_reg_25;
            end
            else begin
               SobelFilter_Mul_12Sx8U_12S_4_23_in2 = filter_out1[11:0];
            end
         end

         // resource: mux_8bx2i0c
         always @(o_result_b_data or o_result_g_data or gs_ctrl0)
          begin :drive_SobelFilter_Mul_12Sx8U_12S_4_23_in1
            if (gs_ctrl0) begin
               SobelFilter_Mul_12Sx8U_12S_4_23_in1 = o_result_b_data;
            end
            else begin
               SobelFilter_Mul_12Sx8U_12S_4_23_in1 = o_result_g_data;
            end
         end

         // resource: SobelFilter_Mul_12Sx8U_12S_4  instance: SobelFilter_Mul_12Sx8U_12S_4_23
         assign SobelFilter_Mul_12Sx8U_12S_4_23_out1 = SobelFilter_Mul_12Sx8U_12S_4_23_in2*{4'b0000, SobelFilter_Mul_12Sx8U_12S_4_23_in1};

         // resource: mux_12bx2i0c
         always @(s_reg_20 or s_reg_21 or gs_ctrl0)
          begin :drive_SobelFilter_Add_12Ux12U_12U_4_24_in1
            if (gs_ctrl0) begin
               SobelFilter_Add_12Ux12U_12U_4_24_in1 = s_reg_20;
            end
            else begin
               SobelFilter_Add_12Ux12U_12U_4_24_in1 = s_reg_21;
            end
         end

         // resource: SobelFilter_Add_12Ux12U_12U_4  instance: SobelFilter_Add_12Ux12U_12U_4_24
         assign SobelFilter_Add_12Ux12U_12U_4_24_out1 = SobelFilter_Mul_12Sx8U_12S_4_23_out1 + SobelFilter_Add_12Ux12U_12U_4_24_in1;

         // resource: SobelFilter_LessThan_2Ux2U_1U_4  instance: SobelFilter_LessThan_2Ux2U_1U_4_27
         assign SobelFilter_LessThan_2Ux2U_1U_4_27_out1 = s_reg_24 < 2'd3;

         // resource: SobelFilter_Add_12Ux12U_12U_4  instance: SobelFilter_Add_12Ux12U_12U_4_28
         assign SobelFilter_Add_12Ux12U_12U_4_28_out1 = s_reg_26 + s_reg_22;

         // resource: SobelFilter_LessThan_2Ux2U_1U_4  instance: SobelFilter_LessThan_2Ux2U_1U_4_29
         assign SobelFilter_LessThan_2Ux2U_1U_4_29_out1 = s_reg_23 < 2'd3;
         ...
         always @(SobelFilter_LessThan_2Ux2U_1U_4_27_out1 or SobelFilter_LessThan_2Ux2U_1U_4_29_out1 or global_state)
         ...
         assign i_r_busy = SobelFilter_gen_busy_r_4_34_out1[2];

         // resource: SobelFilter_gen_busy_r_4  instance: SobelFilter_gen_busy_r_4_34
         assign SobelFilter_gen_busy_r_4_34_out1 = {SobelFilter_gen_busy_r_4_34_gnew_req_i1, {SobelFilter_gen_busy_r_4_34_gdiv_i3, SobelFilter_gen_busy_r_4_34_gen_busy_0_i_r_m_data_is_invalid_next}};

         // resource: SobelFilter_gen_busy_r_4  instance: SobelFilter_gen_busy_r_4_34
         assign SobelFilter_gen_busy_r_4_34_gen_busy_0_i_r_m_data_is_invalid_next = ~SobelFilter_gen_busy_r_4_34_gdiv_i3;

         // resource: SobelFilter_gen_busy_r_4  instance: SobelFilter_gen_busy_r_4_34
         assign SobelFilter_gen_busy_r_4_34_gdiv_i3 = i_r_vld & !SobelFilter_gen_busy_r_4_34_gnew_req_i1;

         // resource: SobelFilter_gen_busy_r_4  instance: SobelFilter_gen_busy_r_4_34
         assign SobelFilter_gen_busy_r_4_34_gnew_req_i1 = i_r_m_busy_req_0 & (i_r_m_unvalidated_req | i_r_vld);
         ...
         always @(posedge i_clk)
          begin :drive_i_r_m_unvalidated_req
            if (i_rst == 1'b0) begin
               ...
               i_r_m_unvalidated_req <= SobelFilter_N_Muxb_1_2_0_4_10_out1;
            end
         end

         // resource: SobelFilter_N_Muxb_1_2_0_4
         always @(i_r_vld or i_r_m_busy_req_0 or i_r_m_unvalidated_req)
          begin :SobelFilter_N_Muxb_1_2_0_4_10
            if (i_r_m_busy_req_0) begin
               SobelFilter_N_Muxb_1_2_0_4_10_out1 = i_r_m_unvalidated_req;
            end
            else begin
               SobelFilter_N_Muxb_1_2_0_4_10_out1 = i_r_vld;
            end
         end

         // instance: drive_i_g_busy
         assign i_g_busy = SobelFilter_gen_busy_r_4_35_out1[2];
         ...
         // resource: SobelFilter_gen_busy_r_4  instance: SobelFilter_gen_busy_r_4_35
         assign SobelFilter_gen_busy_r_4_35_gdiv_i3 = i_g_vld & !SobelFilter_gen_busy_r_4_35_gnew_req_i1;

         // resource: SobelFilter_gen_busy_r_4  instance: SobelFilter_gen_busy_r_4_35
         assign SobelFilter_gen_busy_r_4_35_gnew_req_i1 = i_g_m_busy_req_0 & (i_g_m_unvalidated_req | i_g_vld);
         ...
         always @(posedge i_clk)
          begin :drive_i_g_m_unvalidated_req
            if (i_rst == 1'b0) begin
               ...
               i_g_m_unvalidated_req <= SobelFilter_N_Muxb_1_2_0_4_13_out1;
            end
         end

         // resource: SobelFilter_N_Muxb_1_2_0_4
         always @(i_g_vld or i_g_m_busy_req_0 or i_g_m_unvalidated_req)
          begin :SobelFilter_N_Muxb_1_2_0_4_13
            if (i_g_m_busy_req_0) begin
               SobelFilter_N_Muxb_1_2_0_4_13_out1 = i_g_m_unvalidated_req;
            end
            else begin
               SobelFilter_N_Muxb_1_2_0_4_13_out1 = i_g_vld;
            end
         end

         // instance: drive_i_b_busy
         assign i_b_busy = SobelFilter_gen_busy_r_4_36_out1[2];
         ...
         // resource: SobelFilter_gen_busy_r_4  instance: SobelFilter_gen_busy_r_4_36
         assign SobelFilter_gen_busy_r_4_36_gdiv_i3 = i_b_vld & !SobelFilter_gen_busy_r_4_36_gnew_req_i1;

         // resource: SobelFilter_gen_busy_r_4  instance: SobelFilter_gen_busy_r_4_36
         assign SobelFilter_gen_busy_r_4_36_gnew_req_i1 = i_b_m_busy_req_0 & (i_b_m_unvalidated_req | i_b_vld);
         ...
         always @(posedge i_clk)
          begin :drive_i_b_m_unvalidated_req
            if (i_rst == 1'b0) begin
               ...
               i_b_m_unvalidated_req <= SobelFilter_N_Muxb_1_2_0_4_16_out1;
            end
         end

         // resource: SobelFilter_N_Muxb_1_2_0_4
         always @(i_b_vld or i_b_m_busy_req_0 or i_b_m_unvalidated_req)
          begin :SobelFilter_N_Muxb_1_2_0_4_16
            if (i_b_m_busy_req_0) begin
               SobelFilter_N_Muxb_1_2_0_4_16_out1 = i_b_m_unvalidated_req;
            end
            else begin
               SobelFilter_N_Muxb_1_2_0_4_16_out1 = i_b_vld;
            end
         end
         ...
         always @(posedge i_clk)
          begin :drive_o_result_r_m_unacked_req
            if (i_rst == 1'b0) begin
               ...
               o_result_r_m_unacked_req <= SobelFilter_And_1Ux1U_1U_4_30_out1;
            end
         end

         // resource: SobelFilter_And_1Ux1U_1U_4  instance: SobelFilter_And_1Ux1U_1U_4_30
         assign SobelFilter_And_1Ux1U_1U_4_30_out1 = o_result_r_busy & o_result_r_vld;
         ...
         always @(posedge i_clk)
          begin :drive_o_result_g_m_unacked_req
            if (i_rst == 1'b0) begin
               ...
               o_result_g_m_unacked_req <= SobelFilter_And_1Ux1U_1U_4_31_out1;
            end
         end

         // resource: SobelFilter_And_1Ux1U_1U_4  instance: SobelFilter_And_1Ux1U_1U_4_31
         assign SobelFilter_And_1Ux1U_1U_4_31_out1 = o_result_g_busy & o_result_g_vld;
         ...
         always @(posedge i_clk)
          begin :drive_o_result_b_m_unacked_req
            if (i_rst == 1'b0) begin
               ...
               o_result_b_m_unacked_req <= SobelFilter_And_1Ux1U_1U_4_32_out1;
            end
         end

         // resource: SobelFilter_And_1Ux1U_1U_4  instance: SobelFilter_And_1Ux1U_1U_4_32
         assign SobelFilter_And_1Ux1U_1U_4_32_out1 = o_result_b_busy & o_result_b_vld;
