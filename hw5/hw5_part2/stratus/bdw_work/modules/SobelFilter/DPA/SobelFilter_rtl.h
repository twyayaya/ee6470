...
struct SobelFilter : public sc_module {
  ...
  sc_signal<sc_uint<1> > SobelFilter_N_Muxb_1_2_11_4_16_out1;
  sc_signal<bool > i_b_m_unvalidated_req;
  sc_signal<sc_uint<1> > 
  SobelFilter_gen_busy_r_4_32_gen_busy_0_i_r_m_data_is_invalid_next;
  sc_signal<sc_uint<1> > SobelFilter_gen_busy_r_4_32_gdiv_i3;
  sc_signal<sc_uint<1> > SobelFilter_gen_busy_r_4_32_gnew_req_i1;
  sc_signal<sc_uint<1> > SobelFilter_N_Muxb_1_2_11_4_13_out1;
  sc_signal<bool > i_g_m_unvalidated_req;
  sc_signal<sc_uint<1> > 
  SobelFilter_gen_busy_r_4_31_gen_busy_0_i_r_m_data_is_invalid_next;
  sc_signal<sc_uint<1> > SobelFilter_gen_busy_r_4_31_gdiv_i3;
  sc_signal<sc_uint<1> > SobelFilter_gen_busy_r_4_31_gnew_req_i1;
  sc_signal<sc_uint<1> > SobelFilter_N_Muxb_1_2_11_4_10_out1;
  sc_signal<bool > i_r_m_unvalidated_req;
  sc_signal<sc_uint<1> > 
  SobelFilter_gen_busy_r_4_30_gen_busy_0_i_r_m_data_is_invalid_next;
  sc_signal<sc_uint<1> > SobelFilter_gen_busy_r_4_30_gdiv_i3;
  sc_signal<sc_uint<1> > SobelFilter_gen_busy_r_4_30_gnew_req_i1;
  sc_signal<sc_uint<4> > global_state_next;
  sc_signal<sc_int<12> > SobelFilter_Add2Mul2s12u8u12_4_21_in1;
  sc_signal<sc_uint<8> > SobelFilter_Add2Mul2s12u8u12_4_21_in2;
  sc_signal<sc_uint<12> > SobelFilter_Add2Mul2s12u8u12_4_21_in3;
  ...
  sc_signal<sc_uint<12> > SobelFilter_Add2Mul2s12u8u12_4_21_out1;
  sc_signal<sc_uint<12> > SobelFilter_Add2Mul2s12u8u12_4_25_out1;
  sc_signal<sc_uint<2> > s_reg_24;
  sc_signal<sc_uint<2> > s_reg_19;
  sc_signal<sc_uint<3> > SobelFilter_gen_busy_r_4_30_out1;
  sc_signal<sc_uint<3> > SobelFilter_gen_busy_r_4_31_out1;
  sc_signal<sc_uint<3> > SobelFilter_gen_busy_r_4_32_out1;
  sc_signal<sc_uint<1> > SobelFilter_And_1Ux1U_1U_4_26_out1;
  sc_signal<sc_uint<1> > SobelFilter_And_1Ux1U_1U_4_27_out1;
  sc_signal<sc_uint<1> > SobelFilter_And_1Ux1U_1U_4_28_out1;
  ...
  sc_signal<sc_uint<1> > SobelFilter_Lti3u2_4_23_out1;
  sc_signal<sc_uint<1> > SobelFilter_Lti3u2_4_22_out1;
  ...
  void drive_SobelFilter_Add2Mul2s12u8u12_4_21_in3();
  void drive_SobelFilter_Add2Mul2s12u8u12_4_21_in2();
  void drive_SobelFilter_Add2Mul2s12u8u12_4_21_in1();
  void SobelFilter_Add2Mul2s12u8u12_4_21();
  void SobelFilter_Lti3u2_4_22();
  void SobelFilter_Lti3u2_4_23();
  void SobelFilter_Add2Mul2s12u8u12_4_25();
  void drive_global_state();
  void drive_global_state_next();
  void drive_gs_ctrl0();
  void drive_i_r_busy();
  void SobelFilter_gen_busy_r_4_30_p8();
  void SobelFilter_gen_busy_r_4_30_p7();
  void SobelFilter_gen_busy_r_4_30_p6();
  void SobelFilter_gen_busy_r_4_30_p5();
  void drive_i_r_m_unvalidated_req();
  void SobelFilter_N_Muxb_1_2_11_4_10();
  void drive_i_g_busy();
  void SobelFilter_gen_busy_r_4_31_p8();
  void SobelFilter_gen_busy_r_4_31_p7();
  void SobelFilter_gen_busy_r_4_31_p6();
  void SobelFilter_gen_busy_r_4_31_p5();
  void drive_i_g_m_unvalidated_req();
  void SobelFilter_N_Muxb_1_2_11_4_13();
  void drive_i_b_busy();
  void SobelFilter_gen_busy_r_4_32_p8();
  void SobelFilter_gen_busy_r_4_32_p7();
  void SobelFilter_gen_busy_r_4_32_p6();
  void SobelFilter_gen_busy_r_4_32_p5();
  void drive_i_b_m_unvalidated_req();
  void SobelFilter_N_Muxb_1_2_11_4_16();
  void drive_o_result_r_vld();
  void SobelFilter_Or_1Ux1U_1U_4_2();
  void drive_o_result_r_m_unacked_req();
  void SobelFilter_And_1Ux1U_1U_4_26();
  ...
  void SobelFilter_And_1Ux1U_1U_4_28();
